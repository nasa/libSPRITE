...
namespace units
{
    ...
    void Feetpersecondpersecond_ut::test()
    {
        ...
        CPPUNIT_ASSERT_DOUBLES_EQUAL(fpsps, Feetpersecondpersecond(mpsps),
                                     EPSILON);
        CPPUNIT_ASSERT_DOUBLES_EQUAL(fpsps, Feetpersecondpersecond(fpsps),
                                     EPSILON);

        CPPUNIT_ASSERT_DOUBLES_EQUAL(
            METERS_PER_FOOT, fpsps.toMeterspersecondpersecond(), EPSILON);
