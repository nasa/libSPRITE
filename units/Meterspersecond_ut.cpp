...
namespace units
{
    ...
    void Meterspersecond_ut::test()
    {
        ...
        CPPUNIT_ASSERT_DOUBLES_EQUAL(MPS_TO_KPH, mps.toKilometersperhour(),
                                     EPSILON);
        CPPUNIT_ASSERT_DOUBLES_EQUAL(MPS_TO_FPS, mps.toFeetpersecond(),
                                     EPSILON);
        ...
        CPPUNIT_ASSERT_DOUBLES_EQUAL(98.425196850393701, mps.toFeetpersecond(),
                                     EPSILON);
    }
